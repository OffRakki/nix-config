{config, ...}: {
  xdg.configFile."podmanConfigs/glance/glance.yaml".text = ''
    theme:
      background-color: 50 1 6
      primary-color: 24 97 58
      negative-color: 209 88 54
      background: "/home/rakki/Documents/nixConfig/hosts/sora/wallpapers/agbg.jpg"
          ...
          - size: small
            widgets:
              - type: dns-stats
                ...
                password: ${config.sops.secrets.piholePass.path}
          ...
          - size: full
            widgets:
              - type: monitor
                ...
                sites:
                  - title: open-webui
                    url: https://gpt.tmpst.moe/
                    icon: sh:open-webui
                  - title: glance
                    url: https://glance.tmpst.moe/
                    icon: sh:glance
                  - title: portainer
                    url: https://glance.tmpst.moe/
                    alt-status-codes:
                    ...
                    icon: sh:portainer
                  - title: pihole
                    url: https://pihole.tmpst.moe/
                    alt-status-codes:
                      - 403
                    icon: sh:pihole
                  - title: n8n
                    url: https://n8n.tmpst.moe/
                    icon: sh:n8n
                  - title: it-tools
                    url: https://tools.tmpst.moe/
                    icon: sh:it-tools
                  - title: filebrowser
                    url: https://files.tmpst.moe/
                    icon: sh:filebrowser
                  - title: grafana
                    url: https://grafana.tmpst.moe/
                    icon: sh:grafana
                  #TODO
                  #- title: mc-server
                  #  url: http://mc-server:25565
                  #  icon: sh:minecraft
              - type: custom-api
                title: Minecraft
          ...
          - size: small
            widgets:
              ...
              - type: releases
                ...
                token: ${config.sops.secrets.gitToken.path}
                repositories:
                  - offrakki/nix-config
                  - glanceapp/glance
                  - immich-app/immich
              ...
              - type: repository
                repository: offrakki/nix-config
                  ...
                  - type: bookmarks
                    groups:
                      - title: docker
                        ...
                        links:
                          - title: portainer
                            url: https://portainer.tmpst.moe/
                          - title: pihole
                            url: https://pihole.tmpst.moe/admin
                          - title: filebrowser
                            url: https://files.tmpst.moe/
                          - title: n8n
                            url: https://n8n.tmpst.moe/
          ...
          - size: full
            widgets:
              ...
              - type: videos
                ...
                video-url-template: https://www.yout-ube.com/watch?v={VIDEO-ID}
                channels:
                  - UC3IZKseVpdzPSBaWxBxundA
                  - UCIhx8gV4mgRybaXcZnY5WVA
                  - UCNvpIHxl9rKaSF9O1Ao5nsQ
                  - UCiLb0XHjvUs7t1LUFMXpifQ
                  - UCOU2PEQuXiz4JsfEtW3frhA
                  - UCO1nS8A9cfvsiV3WAJQ5Omg
                  - UC2a8ylUeUkGmlngU97G_7Zg
                  - UCBsbiFGTDdyGexPN95GFqGQ
                  - UCturwbSUudsMaYV_JR2KjZA
              ...
              - type: rss
                ...
                title: Dorama
                collapse-after: 10
                title-url: https://www.hallyudorama.com/
                style: horizontal-cards
                thumbnail-height: 32
                feeds:
                  - url: https://www.hallyudorama.com/feed/
                    title: MV
              ...
              - type: custom-api
                ...
                template: |
                  <div class="flex justify-between text-center">
                    <div>
                        <div class="color-highlight size-h4">{{ .JSON.String "romaji" }} {{ .JSON.String "word" }}</div>
                    </div>
                  </div>
